...
| S1 | AWS Security | Restringir acesso e hardening de instâncias EC2 (SG, NACL, IMDSv2, SSH policy, patching baseline) | In Progress | 70% | Médio: IMDSv2 + termination protection + IAM profile + SSM online aplicados em DEV/PROD; pendente principal: criptografia EBS do root volume (requer downtime) e refinamento fino de SSH/NACL | pending-commit | 2026-02-12 |
