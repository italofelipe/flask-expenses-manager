...
| D1 | Investimentos | Entidade de operacoes (`buy`/`sell`) com data, preco, quantidade, taxas | In Progress | 70% | Alto: base necessaria para analytics confiavel | 94c94db, pending-commit | 2026-02-09 |
