...
| I7 | Deploy AWS | Observabilidade mínima (logs centralizados, métricas, alertas básicos) | In Progress | 85% | Medio: métricas/alertas base ok; logs CloudWatch via `awslogs` overlay pronto; health endpoint `/healthz` criado e healthcheck do compose atualizado; falta aplicar overlay em EC2 e adicionar alertas por 5xx/canary | pending-commit | 2026-02-13 |
