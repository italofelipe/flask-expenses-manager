...
| I7 | Deploy AWS | Observabilidade mínima (logs centralizados, métricas, alertas básicos) | In Progress | 92% | Medio: métricas/alertas base ok; logs CloudWatch via `awslogs` overlay pronto; health endpoint `/healthz` criado; Route53 health checks + alarmes criados; falta aplicar overlay em EC2 e validar ingestão de logs/streams | pending-commit | 2026-02-13 |
