...
| I8 | Deploy AWS | Hardening de produção (secrets, TLS, firewall, least-privilege IAM) | In Progress | 55% | Alto: ainda falta least-privilege IAM e runbook; firewall host (UFW) aplicado em DEV/PROD via SSM e verificado | 5825206, 2b2459c | 2026-02-13 |
