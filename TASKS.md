...
| CD-07 | CD | Corrigir falha de bootstrap no deploy remoto (`missing required file: scripts/ensure_tls_runtime.sh`) com fallback compatível para refs legados e ambientes já provisionados | In Progress | 98% | Médio: até validar novo run, ainda existe risco residual de readiness check e runtime drift entre host/container | pending-commit | 2026-02-18 |
