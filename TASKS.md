...
| G16 | Quality | Reduzir warnings globais de deprecacao (Marshmallow v4, apispec schema naming, warnings de terceiros) com plano faseado | In Progress | 62% | Medio: remanescente em parsing de query (`missing=` em wallet resources) e warnings de libs terceiras (apispec/schemathesis) | pending-commit | 2026-02-12 |
