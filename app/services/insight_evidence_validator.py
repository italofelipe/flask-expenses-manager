...
_DIMENSION_EVIDENCE_PREFIXES: dict[str, tuple[str, ...] | None] = {
    ...
    "transactions": (
        ...
        "comparisons",
        # The transactions narrative legitimately weaves in goals, wallet and
        # forward projections (#1394), so those prefixes are allowed here too.
        "goals",
        "wallet",
        "projections",
    ...
    "goals": ("goals", "projections", "data_quality.domain_presence.goals"),
