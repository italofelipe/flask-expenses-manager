...
- Handoff pre-migracao para `auraxis-platform` publicado em `.context/handoffs/`.
...
8. Após mover o backend para `auraxis-platform/repos/auraxis-api`, revisar paths absolutos remanescentes em scripts e docs.
